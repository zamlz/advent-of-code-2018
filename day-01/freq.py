...
# is that we only have one device and you're the best person for the job!
...
for d in deltas:
    print("| Current Frequency: {:>8} ".format(freq), end='')
    print("| Change of {:>8} ".format(d), end='')
    freq += int(d)
    print("| Resulting Frequency {:>8} |".format(freq))

print('*' + '-'*81 + '*')
print("\nFinal Resulting Frequency: {}\n".format(freq))
...
for i in range(1000000):
    ...
    print("\nUnable to find repeated frequency.\n")
